...
public class Part1b  {
	...
	public static void main(String[] args) {
		...
		ConstraintNetworkAnimator animator = new ConstraintNetworkAnimator(activityNetworkSolver, 1000, cb);
		...
		animator.addDispatchingFunctions(activityNetworkSolver, dispatches.toArray(new DispatchingFunction[dispatches.size()]));
		...
		TimelinePublisher tp = new TimelinePublisher((ActivityNetworkSolver)activityNetworkSolver, new Bounds(0,120000), true, "turtlebot_1", "turtlebot_2");
